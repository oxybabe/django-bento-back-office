...
from menu_app.views import appetizer_record, create_appetizer, create_dessert, create_main_course, delete_desserts, delete_main_course, dessert_record, main_record, delete_appetizer, update_appetizer, update_dessert, update_main_course
